      ...
      <div className="max-w-[960px] mx-auto px-10 pt-20 pb-16 flex flex-col gap-8 items-center">
        ...
        <div className="flex flex-col gap-3 w-[780px]">
          <div className="flex items-center gap-3">
            <span className="text-accent-green font-bold text-[36px] leading-none">$</span>
        ...
        <div className="flex flex-col gap-6 w-full">
          ...
          <div className="flex items-center justify-between w-full">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-bold text-text-primary">shame_leaderboard</h2>
            </div>
            <Link href="/leaderboard">
              <Button variant="link" size="xs">$ view_all &gt;&gt;</Button>
            </Link>
          </div>
          ...
          <div className="border border-border-primary w-full">
            ...
            <div className="flex items-center h-10 px-5 bg-bg-surface border-b border-border-primary">
              <span className="w-[50px] text-text-tertiary text-xs font-mono">rank</span>
              <span className="w-[70px] text-text-tertiary text-xs font-mono">score</span>
              <span className="flex-1 text-text-tertiary text-xs font-mono">code</span>
              <span className="w-[100px] text-text-tertiary text-xs font-mono text-right">lang</span>
            </div>
          ...
          <div className="flex justify-center">
            <p className="text-text-tertiary text-[12px] font-mono">
              ...
              <Link href="/leaderboard" className="hover:text-text-secondary transition-colors">
